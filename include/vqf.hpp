...
public:
     ...
     */
    void updateGyr(const vqf_real_t gyr[3], vqf_real_t dt);
    /**
     ...
     * @param acc accelerometer measurement in m/s²
     */
    void update(const vqf_real_t gyr[3], const vqf_real_t acc[3], vqf_real_t dt);
    /**
     ...
     * @param mag magnetometer measurement in arbitrary units
     */
    void update(const vqf_real_t gyr[3], const vqf_real_t acc[3], const vqf_real_t mag[3], vqf_real_t dt);
